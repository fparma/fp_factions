...
class cfgvehicles
{
	...
	class FP_Faction_EGER85_Soldier_BASE: B_Soldier_F
	{
		...
		weapons[] = {"hlc_rifle_mpikms","Throw","Put"};
		respawnWeapons[] = {"hlc_rifle_mpikms","Throw","Put"};
	...
	class FP_Faction_EGER85_AR: FP_Faction_EGER85_Soldier_BASE
	{
		...
		magazines[] = {"hlc_45Rnd_762x39_m_rpk","hlc_45Rnd_762x39_m_rpk","RH_8Rnd_9x18_Mak","RH_8Rnd_9x18_Mak","RH_8Rnd_9x18_Mak","HandGrenade","HandGrenade","SmokeShell","SmokeShell"};
		respawnMagazines[] = {"hlc_45Rnd_762x39_m_rpk","hlc_45Rnd_762x39_m_rpk","RH_8Rnd_9x18_Mak","RH_8Rnd_9x18_Mak","RH_8Rnd_9x18_Mak","HandGrenade","HandGrenade","SmokeShell","SmokeShell"};
		cost = 95000;
		threat[] = {1,0.1,0.3};
		icon = "iconManMG";
	...
	class FP_Faction_EGER85_SL: FP_Faction_EGER85_Soldier_BASE
	{
		...
		weapons[] = {"hlc_rifle_mpikms","RH_mak","Throw","Put","Binocular"};
		respawnWeapons[] = {"hlc_rifle_mpikms","RH_mak","Throw","Put","Binocular"};
	...
	class FP_Faction_EGER85_TL: FP_Faction_EGER85_Soldier_BASE
	{
		...
		weapons[] = {"hlc_rifle_mpikms","RH_mak","Throw","Put"};
		respawnWeapons[] = {"hlc_rifle_mpikms","RH_mak","Throw","Put"};
	...
	class FP_Faction_EGER85_MAT: FP_Faction_EGER85_Soldier_BASE
	{
		...
		weapons[] = {"hlc_rifle_mpikms","CUP_launch_RPG7V_EGERpgo","Throw","Put"};
		respawnWeapons[] = {"hlc_rifle_mpikms","CUP_launch_RPG7V_EGERpgo","Throw","Put"};
	...
	class FP_Faction_EGER85_MANPADS: FP_Faction_EGER85_Soldier_BASE
	{
		...
		weapons[] = {"hlc_rifle_mpikms","CUP_launch_9K32Strela","Throw","Put"};
		respawnWeapons[] = {"hlc_rifle_mpikms","CUP_launch_9K32Strela","Throw","Put"};
		magazines[] = {"hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","SmokeShell","SmokeShell"};
		respawnMagazines[] = {"hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","hlc_30Rnd_762x39_b_ak","SmokeShell","SmokeShell"};
		cost = 180000;
		threat[] = {1,0.7,0.3};
