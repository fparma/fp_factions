...
{	
	...
	class FP_GOR_rhs_uniform_vkpo_base_syrian: rhs_vkpo_base
	{
		...
		{
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_syrian_vest_co.paa",
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_syrian_pant_co.paa",
	...
	class FP_GOR_rhs_uniform_vkpo_base_desertpink: rhs_vkpo_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_desertpink_vest_co.paa",
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_desertpink_pant_co.paa",
			"rhsafrf\addons\rhs_infantry3\ratnik\data\gloves_co.paa"
		};
	};
	...
	class FP_GOR_rhs_uniform_vkpo_base_desertemr: rhs_vkpo_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_desertemr_vest_co.paa",
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_desertemr_pant_co.paa",
			"rhsafrf\addons\rhs_infantry3\ratnik\data\gloves_co.paa"
		};
	};
	...
	class FP_GOR_rhs_uniform_vkpo_base_surpat: rhs_vkpo_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_surpat_vest_co.paa",
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_surpat_pant_co.paa",
			"rhsafrf\addons\rhs_infantry3\ratnik\data\gloves_co.paa"
		};
	};
	...
	class FP_GOR_rhs_uniform_vkpo_base_hextaiga: rhs_vkpo_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_hextaiga_vest_co.paa",
			"\FP_Factions\gordon_reskins_RHS\rhsvkpo\data\lodu_hextaiga_pant_co.paa",
			"rhsafrf\addons\rhs_infantry3\ratnik\data\gloves_co.paa"
		};
	};
