	...
	class APC_Wheeled_03_base_F: Wheeled_APC_F
	{
		...
		class TextureSources
		{
			class Blufor
			{
				...
				textures[]=
				{
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\APC_Wheeled_03_Ext_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\APC_Wheeled_03_Ext2_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\RCWS30_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\APC_Wheeled_03_Ext_alpha_CO.paa",
			...
			class BluforPacific
			{
				...
				textures[]=
				{
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\APC_Wheeled_03_Ext_olive_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\APC_Wheeled_03_Ext2_olive_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\RCWS30_olive_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\pandur\data\APC_Wheeled_03_Ext_alpha_olive_CO.paa",
...
/*	class I_APC_Wheeled_03_cannon_F;
	...
	class FP_GOR_B_APC_Wheeled_03_cannon_F: I_APC_Wheeled_03_cannon_F
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_APC_Wheeled_03_cannon_F.jpg";
		textureList[] = 
		{
			"Blufor", 1
		};
	...
	class FP_GOR_B_T_APC_Wheeled_03_cannon_F: FP_GOR_B_APC_Wheeled_03_cannon_F 
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_T_APC_Wheeled_03_cannon_F.jpg";		
		textureList[] = 
		{
			"BluforPacific", 1
		};
