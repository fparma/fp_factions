...
class CfgVehicles
{
	...
	class MBT_03_base_F: Tank_F
	{
		class TextureSources
		{
			class Blufor
			{
				...
				textures[]=
				{
					"\FP_Factions\gordon_reskins_vehicles\leopard\data\mbt_03_ext01_blufor_co.paa",
					"\FP_Factions\gordon_reskins_vehicles\leopard\data\mbt_03_ext02_blufor_co.paa",
					"\FP_Factions\gordon_reskins_vehicles\leopard\data\mbt_03_rcws_blufor_co.paa",
			...
			class BluforPacific
			{
				...
				textures[]=
				{
					"\FP_Factions\gordon_reskins_vehicles\leopard\data\mbt_03_ext01_bluforpacific_co.paa",
					"\FP_Factions\gordon_reskins_vehicles\leopard\data\mbt_03_ext02_bluforpacific_co.paa",
					"\FP_Factions\gordon_reskins_vehicles\leopard\data\mbt_03_rcws_bluforpacific_co.paa",
	...
	class FP_GOR_B_MBT_03_cannon_F: FP_GOR_B_MBT_03_cannon_BASE4 
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_MBT_03_cannon_F.jpg";	
		textureList[] = 
		{
			"Blufor", 1
		};
	...
	class FP_GOR_B_T_MBT_03_cannon_F: FP_GOR_B_MBT_03_cannon_F 
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_T_MBT_03_cannon_F.jpg";			
		textureList[] = 
		{
			"BluforPacific", 1
		};
