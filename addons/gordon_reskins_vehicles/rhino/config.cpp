...
class CfgVehicles
{
	...
	class FP_GOR_I_AFV_Wheeled_01_cannon_F: FP_GOR_I_AFV_Wheeled_01_cannon_BASE2
	{
		...
		class TextureSources
		{
			class AAF
			{
				...
				textures[]=
				{
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_wheeled_01_EXT1_AAF_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_wheeled_01_EXT2_AAF_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_wheeled_01_wheel_AAF_CO.paa",
					"a3\Armor_F\Data\camonet_AAF_Digi_Green_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_wheeled_01_EXT3_AAF_CO.paa"
				};
				factions[]=
				{
					"IND_F"
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_I_AFV_Wheeled_01_cannon_F.jpg";		
		textureList[] = 
		{
			"AAF", 1
		};
	...
	class FP_GOR_I_AFV_Wheeled_01_up_cannon_F: FP_GOR_I_AFV_Wheeled_01_up_cannon_BASE4
	{
		...
		class TextureSources
		{
			class AAF
			{
				...
				textures[]=
				{
					...
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_wheeled_01_wheel_AAF_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_wheeled_01_EXT3_AAF_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_commander_tow_AAF_CO.paa",
					"a3\Armor_F\Data\camonet_AAF_Digi_Green_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\rhino\data\afv_wheeled_01_EXT3_AAF_CO.paa"
				};
				factions[]=
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_I_AFV_Wheeled_01_up_cannon_F.jpg";			
		textureList[] = 
		{
			"AAF", 1
		};
