...
class CfgVehicles
{
	...
	class MBT_04_base_F: Tank_F
	{
		class TextureSources
		{
			class Blufor
			{
				...
				textures[]=
				{
					"\FP_Factions\gordon_reskins_vehicles\armata\data\MBT_04_exterior_1_blufor_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\armata\data\MBT_04_exterior_2_blufor_CO.paa",
			...
			class BluforPacific
			{
				...
				textures[]=
				{
					"\FP_Factions\gordon_reskins_vehicles\armata\data\MBT_04_exterior_1_bluforpacific_CO.paa",
					"\FP_Factions\gordon_reskins_vehicles\armata\data\MBT_04_exterior_2_bluforpacific_CO.paa",
	...
	class FP_GOR_B_MBT_04_cannon_F: FP_GOR_B_MBT_04_cannon_BASE4 
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_MBT_04_cannon_F.jpg";
		textureList[] = 
		{
			"Blufor", 1
		};
	...
	class FP_GOR_B_T_MBT_04_cannon_F: FP_GOR_B_MBT_04_cannon_F 
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_T_MBT_04_cannon_F.jpg";		
		textureList[] = 
		{
			"BluforPacific", 1
		};
	...
	class FP_GOR_B_MBT_04_command_F: FP_GOR_B_MBT_04_command_BASE4 
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_MBT_04_command_F.jpg";	
		textureList[] = 
		{
			"Blufor", 1
		};
	...
	class FP_GOR_B_T_MBT_04_command_F: FP_GOR_B_MBT_04_command_F 
	{
		...
		editorPreview = "\FP_Factions\gordon_reskins_vehicles\editorpreviews\FP_GOR_B_T_MBT_04_command_F.jpg";			
		textureList[] = 
		{
			"BluforPacific", 1
		};
