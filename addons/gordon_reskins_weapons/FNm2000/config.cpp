...
class CfgWeapons
{
	...
	class FP_GOR_arifle_Mk20_F_black: arifle_Mk20_plain_F
	{
		...
		{
			"\FP_Factions\gordon_reskins_weapons\FNm2000\data\mk20_black_co.paa"
		};
	};
	class FP_GOR_arifle_Mk20_F_olive: arifle_Mk20_plain_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_weapons\FNm2000\data\mk20_olive_co.paa"
		};
	};
	class FP_GOR_arifle_Mk20_F_gray: arifle_Mk20_plain_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_weapons\FNm2000\data\mk20_gray_co.paa"
		};
	};
