...
class CfgWeapons
{
	...
	class FP_GOR_DMR_05_pacifichex_F: srifle_DMR_05_blk_F
	{
		...
		{
			"\FP_Factions\gordon_reskins_weapons\cyrus\data\DMR_05_01_pacific_CO.paa",
			"\FP_Factions\gordon_reskins_weapons\cyrus\data\DMR_05_02_pacific_CO.paa"
		};
	};
	...
	class FP_GOR_DMR_05_olive_F: srifle_DMR_05_blk_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_weapons\cyrus\data\DMR_05_01_olive_CO.paa",
			"\FP_Factions\gordon_reskins_weapons\cyrus\data\DMR_05_02_olive_CO.paa"
		};
	};
};