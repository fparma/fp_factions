...
class CfgWeapons
{
	...
	class FP_GOR_hgun_DEagle_chrome_RF: hgun_DEagle_gold_RF
	{
		...
		{
			"\FP_Factions\gordon_reskins_weapons\rfdeagle\data\deagle_chrome_co.paa",
			"\FP_Factions\gordon_reskins_weapons\rfdeagle\data\deagle_grip_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"\FP_Factions\gordon_reskins_weapons\rfdeagle\data\deagle_chrome.rvmat"
		};
	};
};
