...
class CfgWeapons
{
	...
	class FP_GOR_SMG_01_Black_F: SMG_01_F 
	{
		...
		{
			"\FP_Factions\gordon_reskins_weapons\vector\data\SMG_01_black_co.paa",
	...
	class FP_GOR_SMG_01_Olive_F: SMG_01_F 
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_weapons\vector\data\SMG_01_olive_co.paa",
			"\a3\weapons_f\data\vectoratt_co.paa",
			"\a3\weapons_f\acc\data\battlesight_co.paa"
		};
	};
	...
	class FP_GOR_SMG_01_White_F: SMG_01_F 
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\FP_Factions\gordon_reskins_weapons\vector\data\SMG_01_white_co.paa",
			"\a3\weapons_f\data\vectoratt_co.paa",
			"\a3\weapons_f\acc\data\battlesight_co.paa"
		};
	};
